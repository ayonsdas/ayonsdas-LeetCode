<h2><a href="https://leetcode.com/problems/range-sum-query-2d-mutable/">308. Range Sum Query 2D - Mutable</a></h2><h3>Hard</h3><hr><div><p>Given a 2D matrix <code>matrix</code>, handle multiple queries of the following types:</p>
